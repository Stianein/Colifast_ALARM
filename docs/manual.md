...
- The **up-arrow**  <img src="icons/chevron-up.svg" alt="up button" style="width: 24px; height: auto; vertical-align: bottom;"> will allow you to dispense the volume set in **Syringe Volume (&#956;l)** at the set **Flowrate (&#956;l/s)**.
- The **down-arrow**  <img src="icons/chevron-down.svg" alt="down button" style="width: 24px; height: auto; vertical-align: bottom;"> will allow you to aspirate the volume set in **Syringe Volume (&#956;l)** at the set **Flowrate (&#956;l/s)**.
